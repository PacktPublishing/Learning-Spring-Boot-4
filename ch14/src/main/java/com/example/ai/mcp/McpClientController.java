 ...
 *
 * SyncMcpToolCallbackProvider (org.springframework.ai.mcp) is auto-configured by
 * Spring AI when the MCP client starter is on the classpath. It queries all
 * configured MCP servers for their tool listings at startup.
 */
@RestController
